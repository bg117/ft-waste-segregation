...
class ObjectDetector(Detector):
    def process_image(self, image):
        ...
        # output_details[0] - score
        # output_details[1] - position
        # output_details[2] - count
        # output_details[3] - class

        scores = np.squeeze(self.interpreter.get_tensor(output_details[0]["index"]))
        positions = np.squeeze(self.interpreter.get_tensor(output_details[1]["index"]))
